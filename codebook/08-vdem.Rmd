...
```{r echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
#vdem
googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1aw_byhiC4b_0XPcTDtsCpCeJHabK38i4pCmkHshYMB8/edit#gid=0", range = c("B696:N751"), sheet= "Variables", col_names = F) %>%
